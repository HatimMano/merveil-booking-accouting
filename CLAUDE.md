...
- **Reste** : comparaison saisies Philippe au centime — outillée par le **tab 9.8 Flux 2 Adyen** (dashboards-v2, modèle `dash_finance_flux2_validation`, appariement paiement par paiement vs son journal 5488931) → figer convention frais (lui : TTC banque, frais dans le solde 511035 ; nous : net + 401MEWS) → GO → retirer `bq_only` du body scheduler → il arrête sa saisie. Mail de contexte : `Archides/mail-philippe-flux2-2026-07-26.md`.
